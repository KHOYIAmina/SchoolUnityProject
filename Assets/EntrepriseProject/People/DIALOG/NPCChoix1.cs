...
public class NPCChoix1 : MonoBehaviour
{
    ...
    IEnumerator StartYes(){
        ...
        voiceLine[2].Play();
        subText.GetComponent<Text>().text = "Parfait , Votre encadrant est monsieur X , vous pouvez le trouvez dan la département informatique en premier étage.";
